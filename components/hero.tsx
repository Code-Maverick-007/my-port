        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            <Button variant="outline" size="sm" asChild>
              <a href="https://github.com/Code-Maverick-007" target="_blank" rel="noopener noreferrer">
                <Github className="mr-2 h-4 w-4" />
                GitHub
              </a>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <a href="https://www.linkedin.com/in/omkar-shewale-oo7/" target="_blank" rel="noopener noreferrer">
                <Linkedin className="mr-2 h-4 w-4" />
                LinkedIn
              </a>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <a href="https://leetcode.com/u/Code-Maverick-007/" target="_blank" rel="noopener noreferrer">
                <Code2 className="mr-2 h-4 w-4" />
                LeetCode
              </a>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <a href="https://www.hackerrank.com/profile/omkarshewale205" target="_blank" rel="noopener noreferrer">
                <Code2 className="mr-2 h-4 w-4" />
                HackerRank
              </a>
            </Button>
            ...
            <Button variant="outline" size="sm" asChild>
              <a href="https://codeforces.com/profile/Code-Maverick-007" target="_blank" rel="noopener noreferrer">
                <Code2 className="mr-2 h-4 w-4" />
                CodeForces
              </a>
            </Button>
